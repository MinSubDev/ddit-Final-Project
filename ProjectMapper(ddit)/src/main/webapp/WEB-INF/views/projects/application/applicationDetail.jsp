              ...
              <div class="card-box">
	            ...
	            <div class="date-input-wrapper"> <label for="appInterviewDt" class="form-label">면접일자</label> 
	         		   <div class="d-flex align-items-center"><input type="date" 
	         		   		class="form-control me-2" name="appInterviewDt" value="${application.appInterviewDt}">
		 					<button type="submit" class="btn btn-outline-secondary me-1 mb-1 w-70" name="res" value="interview">
		 					저장</button>
				    	</div>
				</div>
              </div>
